...
public class TaskService {
    ...
    public String newTask(NewTaskRequestDto taskRequest, UserDto user) {
        ...
        TaskPrepareBundleFactory taskPrepareBundleFactory = new TaskPrepareBundleFactory(TEST_PATIENT_ID, TEST_USER_ID,
        ...
        TaskInfoHolder createInfo = new TaskInfoBundleExtractor()
                ...
                .findFirst()
                .orElseThrow(
                        () -> new TaskCreateException("Task/ServiceRequest are not found in the response bundle."));
        ...
        try {
            ...
            ehrClient.transaction()
                    .withBundle(
                            new TaskFailBundleFactory(task, createInfo.getServiceRequest(), exc.getMessage())
                                    .createFailBundle())
                    .execute();
        }
