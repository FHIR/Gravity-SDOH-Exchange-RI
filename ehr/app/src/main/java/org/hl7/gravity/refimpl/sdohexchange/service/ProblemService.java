...
public class ProblemService {
    ...
    public List<ProblemDto> listActive() {
        // TODO: to be rewritten, remove temp TEST_PATIENT_ID
        ...
        // This is risky but in scope of RI with a very limited number of resources -
        // this will work
    ...
    public ProblemDto create(NewProblemDto newProblemDto, UserDto user) {
        ...
        // CurrentContextPrepareBundleFactory currentContextPrepareBundleFactory = new
        ...
        Bundle problemRelatedResources = ehrClient.transaction()
                ...
                .execute();
        CurrentContextPrepareBundleExtractor.CurrentContextPrepareInfoHolder currentContextPrepareInfoHolder = new CurrentContextPrepareBundleExtractor()
                .extract(problemRelatedResources);
    ...
    private Bundle addGoalsToConditionBundle(Bundle responseBundle) {
        // TODO: to be rewritten, remove temp TEST_PATIENT_ID
        // Bundle goals = new GoalQueryFactory().query(ehrClient,
        // SmartOnFhirContext.get()
        // .getPatient())
        Bundle goals = new GoalQueryFactory().query(ehrClient, TEST_PATIENT_ID)
    ...
    private IQuery<IBaseBundle> searchProblemQuery(ConditionClinicalStatusCodes status) {
        ...
        // .getPatient())
        return new ProblemQueryFactory().query(ehrClient, TEST_PATIENT_ID)
